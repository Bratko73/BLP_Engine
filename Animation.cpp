...
sf::Sprite Animation::mirrorUpdate(float time)
{
	...
	sprite.setTextureRect(sf::IntRect(firstFrameCoordinates.x + frameSize.x * int(currentFrame)+frameSize.x, firstFrameCoordinates.y * line, -frameSize.x, frameSize.y));
	return sprite;
}
